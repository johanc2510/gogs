...
// _______________________________   _____    _________.______________ ____ _______________.___.
// \______   \_   _____/\______   \ /     \  /   _____/|   \__    ___//     \\______  \__  |   |
//  |       _/|    __)_  |     ___//  -|-  \ \_____  \ |   | |    |  /  -|-  \|       _//   |   |
//  |    |   \|        \ |    |   /    |    \/        \|   | |    | /    |    \    |   \\____   |
//  |____|_  /_______  / |____|   \_________/_______  /|___| |____| \_________/____|_  // ______|
//         \/        \/                             \/                               \/ \/

type CreateRepo struct {
	UserID         int64  `binding:"Required"`
	RepoName       string `binding:"AlphaDashDot;MaxSize(100)"`
	ItemCode       string `binding:"MaxSize(50)"`  // Campo para o código do item
	NoRegistration bool   `json:"no_registration"` // Checkbox para indicar ausência de cadastro
	Private        bool
	Unlisted       bool
